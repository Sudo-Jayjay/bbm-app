...
<body>
    <?php 
        ...
        $sql = "SELECT * FROM cart WHERE product_id = '$sample' AND user_unique_ID = '$user_ID' AND order_id is NULL";
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                <div class="container-var">
                    <button class="btn" onClick="history.back()"><i class="fa fa-arrow-left fa-sm"></i></button> 
            ...
            <div class="container-fluid"> 
                ...
                <div class="prod-info">
                    ...
                    <p id="prod-price" name="prod-price" style="display: inline-block; margin-left: 20px;"> <?php echo ''.$run_query['p_price'].''; ?></span></p>
                ...
                <div class="add-prod"> 
                    ...
                    <b><p id="prod-num" name="prod-num"><?php echo $rows["item_qty"]; ?></p></b>
                    <button class="btn-add" id="add" onclick="multiply()"><i class="fa-solid fa-plus fa-sm"></i></button> 
                </div> 
  
                <div class="add-to-cart">
                    <button class="btn-add-to-cart" id="btn-add-to-cart" onclick="clickAdd('<?php echo $_GET['id']; ?>');">
                    Update cart <span style="margin-left: 130px; display:inline">P</span> <span id="total"style="margin-right: 20px; float:right"><?php echo $rows["item_price"];?></span>
                    </button>
                </div>  
